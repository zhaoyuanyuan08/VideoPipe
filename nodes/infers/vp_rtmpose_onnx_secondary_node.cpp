#include "vp_rtmpose_onnx_secondary_node.h"
...
namespace vp_nodes {
    ...
    vp_rtmpose_onnx_secondary_node::vp_rtmpose_onnx_secondary_node(
    ...
    void vp_rtmpose_onnx_secondary_node::configure_execution_provider() {
    ...
    bool vp_rtmpose_onnx_secondary_node::append_tensorrt_provider() {
        try {
    ...
    bool vp_rtmpose_onnx_secondary_node::append_cuda_provider() {
        try {
    ...
    vp_rtmpose_onnx_secondary_node::BBox vp_rtmpose_onnx_secondary_node::target_bbox(
    ...
    std::vector<float> vp_rtmpose_onnx_secondary_node::preprocess(const cv::Mat& image, const BBox& bbox) {
    ...
    std::vector<vp_objects::vp_pose_keypoint> vp_rtmpose_onnx_secondary_node::decode_simcc(
        Ort::Value& simcc_x,
        Ort::Value& simcc_y,
        const BBox& bbox) {
    ...
    std::vector<vp_objects::vp_pose_keypoint> vp_rtmpose_onnx_secondary_node::decode_heatmap(
        Ort::Value& heatmap,
        const BBox& bbox) {
    ...
    std::vector<vp_objects::vp_pose_keypoint> vp_rtmpose_onnx_secondary_node::decode_outputs(
    ...
    void vp_rtmpose_onnx_secondary_node::run_infer_combinations(
    ...
    void vp_rtmpose_onnx_secondary_node::postprocess(
